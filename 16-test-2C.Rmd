...
di varianze **eterogenee**, verificare al LdS del 5%, se le due diete 
...
alpha <- 0.05
h1 <- ">"
test_2c(mu1 = mu1,mu2 = mu2,s1h = s1h,s2h =s2h,n1 = n1,n2 = n2,h1 = h1,alpha = alpha,a = a,b = b,um = um,et=T)
```
...
cat(ttest_2c_om(mu1 = mu1,mu2 = mu2,s1h = s1h,s2h =s2h,n1 = n1,n2 = n2,h1 = h1,alpha = alpha,a = a,b = b,um = um ))
