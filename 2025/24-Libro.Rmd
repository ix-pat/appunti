...
# Com'è Realizzato il Libro `r ifelse (html,"{-}","")` 
...
## R: A Language and Environment for Statistical Computing `r ifelse (html,"{-}","")` 
...
### R come calcolatrice `r ifelse (html,"{-}","")` 
...
### Operatori Speciali `r ifelse (html,"{-}","")` 
...
### Vettori e matrici `r ifelse (html,"{-}","")` 
...
### Liste e dataframe `r ifelse (html,"{-}","")` 
...
### Classi e Oggetti `r ifelse (html,"{-}","")` 
...
### Le Funzioni in R `r ifelse (html,"{-}","")` 
...
#### Le funzioni statistiche `r ifelse (html,"{-}","")` 
...
#### Le VC di maggiore interessa `r ifelse (html,"{-}","")` 
...
#### Funzioni tra stringhe `r ifelse (html,"{-}","")` 
...
#### Cicli e Condizioni `r ifelse (html,"{-}","")` 
...
#### Funzioni per Ovviare ai Cicli `r ifelse (html,"{-}","")` 
...
#### Funzioni personalizzate `r ifelse (html,"{-}","")` 
