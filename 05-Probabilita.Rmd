...
```{r unione,out.height="20%",fig.dpi=ifelse(html,160,600)}
...
```{r intersezione,out.height="20%",fig.dpi=ifelse(html,160,600)}
...
```{r complementare,out.height="20%",fig.dpi=ifelse(html,160,600)}
...
```{r demorgan,fig.cap="Regola di De Morgan per due insiemi: la probabilità dell'unione è la somma della probilità di tre eventi disgiunti",out.height="20%",fig.dpi=ifelse(html,160,600)}
...
```{r incomp,fig.cap="Due eventi si dicono incompatibili se sono disgiunti",out.height="20%",fig.dpi=ifelse(html,160,600)}
...
```{r bipartizione,out.height="20%",fig.dpi=ifelse(html,160,600)}
...
```{r npart,out.height="20%",fig.dpi=ifelse(html,160,600)}
...
```{r 2x2,out.height="20%",fig.dpi=ifelse(html,160,600)}
...
```{r nxm,out.height="20%",fig.dpi=ifelse(html,160,600)}
