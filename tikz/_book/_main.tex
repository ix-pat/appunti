...
\KeywordTok{\textbackslash{}begin}\NormalTok{\{}\ExtensionTok{tikzpicture}\NormalTok{\}}
  \FunctionTok{\textbackslash{}node}\NormalTok{[draw, circle] (A) at (0,0) \{A\};}
  \FunctionTok{\textbackslash{}node}\NormalTok{[draw, rectangle] (B) at (2,0) \{B\};}
  \FunctionTok{\textbackslash{}draw}\NormalTok{[{-}\textgreater{}, thick] (A) {-}{-} (B);}
